            ...
            series: [
                {
                    ...
                    seriesLayoutBy: "row",
                    showBackground: true,
                    backgroundStyle: {color: colors.blacklighter, opacity: 0.1},
                    itemStyle: {borderRadius: [10, 10, 0, 0], opacity: 0.8},
                    barWidth: 40,
                },
                {
                    xAxisIndex: 1,
                    ...
                    seriesLayoutBy: "row",
                    showBackground: true,
                    backgroundStyle: {color: colors.blacklighter, opacity: 0.4},
                    itemStyle: {borderRadius: [10, 10, 0, 0], opacity: 0.8},
                    barWidth: 40,
                },
            ],
